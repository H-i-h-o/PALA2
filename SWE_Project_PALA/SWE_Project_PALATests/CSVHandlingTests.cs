...
namespace SWE_Project_PALATests
{
    ...
    public class CSVHandlingTests
    {
        ...
        public void TestCSVHandling()
        {
            ...
            CList1.CustList.Add(new Customer(1, "Patrick", "Gehmayr", "patrick.gehmayr@gmail.com", -155, new DateTime(2016, 3, 26)));
            CList1.CustList.Add(new Customer(2, "Laurenz", "Hiho", "l.hiho@mail.at", 2365, new DateTime(2018, 10, 3)));
            CList1.CustList.Add(new Customer(3, "Max", "Mustermann", "max.muster@anymail.any", int.MinValue, new DateTime(DateTime.Now.Year,DateTime.Now.Month,DateTime.Now.Day)));
