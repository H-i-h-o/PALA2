...
namespace SWE_Project_PALATests
{
    ...
    public class CustomerListTests
    {
        ...
        public void Initialize()
        {
            ...
            TestCustomerList.CustList.Add(new Customer(4, "Patrick", "Gehmayr", "p.gehmayr@gmail.com", -99, new DateTime(2010, 9, 20)));
            TestCustomerList.CustList.Add(new Customer(3, "Laurenz", "Hiho", "l.hiho@mail.at", -50, new DateTime(2013, 2, 28)));
            TestCustomerList.CustList.Add(new Customer(1, "Luigi", "Italiano", "luigi.italy@imail.com", 100, new DateTime(2008, 6, 3)));
            TestCustomerList.CustList.Add(new Customer(2, "Max", "Mustermann", "m.muster@mmail.max", 1300, new DateTime(2018, 7, 20)));
            TestCustomerList.CustList.Add(new Customer(5, "Anna", "Huber", "huber.anna@hmail.at", -3000, new DateTime(2019, 3, 30)));
